...
public class VisualFragment  extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void initData() {
        new OkHttpUtil().get("https://www.guokr.com/apis/minisite/article.json?retrieve_type=by_channel&channel_key=visual", new OkHttpUtil.HttpCallback() {
            @Override
